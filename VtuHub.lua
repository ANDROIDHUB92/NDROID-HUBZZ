https://raw.githubusercontent.com/ANDROIDHUB92/ANDROID-HUB/main/VtuHub.lua
--// Crack By Namfon Hub - https://discord.gg/bxKM2ATuhM
local Android = loadstring(game:HttpGet("https://raw.githubusercontent.com/ANDROIDHUB92/ANDROID-HUB/main/VtuHub.lua"))()
local SaveManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/ANDROIDHUB92/ANDROID-HUB/main/VtuHub.lua"))()
local InterfaceManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/ANDROIDHUB92/ANDROID-HUB/main/VtuHub.lua"))()
local Window = Android:CreateWindow({
...
end)local c= e:Window("KOBEN Hub","11354741327")local e= c:Tab("Main","rbxassetid://16118014535")local f= c:Tab("Main 2","rbxassetid://16118014535")local g= c:Tab("Player/Stats","rbxassetid://16118014535")local h= c:Tab("Combat","rbxassetid://16118014535")local i= c:Tab("Teleport/Sv","rbxassetid://16118014535")local j= c:Tab("Raid","rbxassetid://16118014535")local k= c:Tab("Devil Fruit","rbxassetid://7044233235")local l= c:Tab("Shop","rbxassetid://16118014535")local c= c:Tab("Misc","rbxassetid://16118014535")e:Seperator("Settings")e:Button("Copy Link Discord Server",function()
